...
Twenty gold stars are set in a design conveying American unity, harmony and solidarity. The stars are arranged to resemble the shape of the [Americas](https://en.wikipedia.org/wiki/Americas) as well as a chain link. The chain link is "broken and unfinished" to represent the power of American social movements and the potential of a unified America.
